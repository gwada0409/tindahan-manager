...
The sections below retain the pre-refactor audit as a historical v3 snapshot. Statements using â€œcurrentâ€ in that retained baseline describe the state at Phase 0, not the Phase 1 implementation.
